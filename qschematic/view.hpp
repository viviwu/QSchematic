...
public:
   ...
   */
  [[nodiscard]] qreal zoomValue() const;
...
public Q_SLOTS:
   ...
   *
   * @details This modifies the view transformation to ensure that all items in
   * the scene are visible in the viewport.
   */
  void fitInView();
